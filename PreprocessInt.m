...
function PreprocessInt(pNumber)
    ...
    %cfg.trialdef.eventvalue = {'S 18','S 19','S108','S109','S118','S119','S128','S129','S138','S139'};
    cfg.trialdef.eventvalue = {'S 18','S 19','S108','S109','S138','S139'};
    ...
    %cfgHEOG.trialdef.eventvalue = {'S 18','S 19','S108','S109','S118','S119','S128','S129','S138','S139'};
    cfgHEOG.trialdef.eventvalue = {'S 18','S 19','S108','S109','S138','S139'};  % markers marking stimulus events in the final test
    cfgHEOG.trialdef.eventtype  = 'Stimulus';                                % marker for correctness
    ...
    %cfgVEOG.trialdef.eventvalue = {'S 18','S 19','S108','S109','S118','S119','S128','S129','S138','S139'};  
    cfgVEOG.trialdef.eventvalue = {'S 18','S 19','S108','S109','S138','S139'};  % markers marking stimulus events in the final test
    ...
    %cfgLips.trialdef.eventvalue = {'S 18','S 19','S108','S109','S118','S119','S128','S129','S138','S139'};
    cfgLips.trialdef.eventvalue = {'S 18','S 19','S108','S109','S138','S139'};% markers marking stimulus events in the final test
    ...
    cfg=[];
    % Familiarization
    cfg.trials = find((data_clean.trialinfo(:,5) == 1)& (data_clean.trialinfo(:,1) == 18)); % this assumes that column 5 is accuracy and that correct trials are indicated with 1. 
    data_fam_cond1 = ft_selectdata(cfg, data_clean);
    save(cond1outFam, 'data_fam_cond1');
    
    cfg.trials = find((data_clean.trialinfo(:,5) == 1)& (data_clean.trialinfo(:,1) == 19));
    data_fam_cond2 = ft_selectdata(cfg, data_clean);
    save(cond2outFam, 'data_fam_cond2');
    
    % Picture naming round 1
    cfg.trials = find((data_clean.trialinfo(:,5) == 1)& (data_clean.trialinfo(:,1) == 108));
    data_pic1_cond1 = ft_selectdata(cfg, data_clean);
    save(cond1outPic1, 'data_pic1_cond1');
    
    cfg.trials = find((data_clean.trialinfo(:,5) == 1)& (data_clean.trialinfo(:,1) == 109));
    ...
    cfg.trials = find((data_clean.trialinfo(:,5) == 1)& (data_clean.trialinfo(:,1) == 138));
    data_pic4_cond1 = ft_selectdata(cfg, data_clean);
    save(cond1outPic4, 'data_pic4_cond1');
    
    cfg.trials = find((data_clean.trialinfo(:,5) == 1)& (data_clean.trialinfo(:,1) == 139));
    ...
    disp('##################################################');
    disp(['## Done interference preprocessing PP_', num2str(pNumber),' ########']);
    disp('##################################################');
