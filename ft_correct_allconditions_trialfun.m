function [trl, event] = ft_correct_allconditions_trialfun(cfg)
...
for j = 1:(length(value)-2)
  trg1 = value(j);
  trg2 = value(j+2);
  if (strcmp(trg1,marker1{1}) && strcmp(trg2,marker2)) ||  (strcmp(trg1,marker1{2}) && strcmp(trg2,marker2))
